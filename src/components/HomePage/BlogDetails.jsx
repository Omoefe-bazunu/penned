  ...
  return (
    <div className="BlogDetailsWrapper w-5/6 h-fit flex gap-4">
      ...
      {post && <div className="postwrapper w-full h-full flex flex-col justify-start items-center gap-5">
            ...
            <img src={ImageSrc} alt="featured-Image" className=" w-50 h-50  mb-8 bg-cover bg-center bg-no-repeat text-white"></img>
            <p className="text-white mb-8 whitespace-pre-wrap">{post.body}</p>
          </div>
              <div className="reactions absolute bottom-0 -right-2 cursor-pointer w-10 h-10 rounded-full bg-white authenticated">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" className="size-6  Reaction mt-2 mx-auto" onClick={handleReaction}>
