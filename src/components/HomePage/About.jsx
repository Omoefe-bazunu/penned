  ...
  return (
    <div className="AboutWrapper w-5/6 h-full flex justify-start items-center gap-8" >
        ...
        <div className="AboutDetails text-white flex flex-col justify-start gap-3 border-l-2 border-white pl-8 w-full">
            <p className=" font-light">PENNED is a "free for all" Blog that allows creatives around the world to pen their thoughts and share their stories to a global audience. Regardless of your age, field or region, PENNED is free for you to be at your best.
            </p>
